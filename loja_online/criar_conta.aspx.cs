...
{
    public partial class criar_conta_aspx : System.Web.UI.Page
    {
        ...
        protected void btn_criar_conta_Click(object sender, EventArgs e)
        {
            ...
            mycomm.CommandText = "inserir_cliente_ou_revendedor_ativacao";
            ...
            mycomm.Parameters.AddWithValue("@nif", txt_nif.Text);
            mycomm.Parameters.AddWithValue("@tipo_cliente", ddl_tipo.Text);
            ...
            if (resposta == 1)
            {
               ...
               string cargo = ddl_tipo.SelectedItem.ToString();

                if (cargo == "Cliente")
                {
                    email.Body = "<b>Obrigado pelo Registo na nossa aplicação.<br/> Para ativar a sua conta carregue <a href='https://localhost:44383/ativacao_cliente.aspx?username=" + EncryptString(txt_username.Text) + "'>aqui";
