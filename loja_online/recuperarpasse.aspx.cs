...
{
    public partial class recuperarpasse : System.Web.UI.Page
    {
        ...
        protected void btn_recuperarConta_Click(object sender, EventArgs e)
        {
            ...
            if (resposta == 1)
            {
                ...
                email.Body = "<b>Pediu para recuperar a palavra passe?<br/>Se não pediu ignore o link enviado <br/> Carregue neste link para alterar a palavra passe: <a href='https://localhost:44383/rec_passe.aspx?username=" + EncryptString(txt_username.Text) + "&email="+ EncryptString(txt_email.Text) + "&hora"+ EncryptString(DateTime.Now.ToString())+ "'aqui><br/><br/> Sugerimos que altere a sua palavra passe pois é sinal que andam a tentar entrar na sua conta!!!";

                //+"?email=" + EncryptString(txt_email.Text)
